...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.potential.setGeometry(QtCore.QRect(10, 50, 501, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.okButton.setGeometry(QtCore.QRect(520, 10, 71, 71))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.okButton.setFont(font)
        self.okButton.setObjectName("okButton")
        self.conditions = QtWidgets.QPlainTextEdit(self.frame)
        self.conditions.setGeometry(QtCore.QRect(10, 90, 501, 31))
        font = QtGui.QFont()
        ...
        self.settings.setGeometry(QtCore.QRect(10, 10, 501, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.verticalSlider_3.setGeometry(QtCore.QRect(670, 10, 16, 111))
