...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.arcRemButton = QtWidgets.QPushButton(self.centralwidget)
        self.arcRemButton.setGeometry(QtCore.QRect(1020, 63, 41, 41))
        self.arcRemButton.setObjectName("arcRemButton")
        self.arcAddButton = QtWidgets.QPushButton(self.centralwidget)
        self.arcAddButton.setGeometry(QtCore.QRect(1020, 20, 41, 41))
